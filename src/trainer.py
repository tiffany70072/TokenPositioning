...
class Trainer(object):
	...
	def train(self): 
		...
		self.seq2seq.seq2seq_model.compile(optimizer="adam",
								...
								metrics=[utils.whole_accuracy, utils.each_accuracy, utils.accuracy_length])
		# TODO: (Remove) metrics=[metrics.categorical_accuracy, utils.each_accuracy, utils.accuracy_length])
		...
		#self.trace_history(0, 0) # history)
		#import pdb
		#pdb.set_trace()
